...
public class SexyNakedsParser : GenericBabesGalleryParser, IHtmlParser
{
    ...
    public SexyNakedsParser(WebDriver driver, ApiClientManager clientManager, Dictionary<string, string> requestHeaders,
                            FilenameScheme filenameScheme = FilenameScheme.Original) : base(driver, clientManager,
        requestHeaders, IHtmlParser.GetFilenameScheme<SexyNakedsParser>(filenameScheme))
    {
    }
}