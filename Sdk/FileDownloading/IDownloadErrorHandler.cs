...
public interface IDownloadErrorHandler
{
    ...
    /// <returns>
    /// Retry to re-attempt now that state (e.g. link.Url) may have been adjusted; may also throw to unwind to a
    /// higher-level recovery path (e.g. EHentaiUrlExpiredException).
    /// </returns>
