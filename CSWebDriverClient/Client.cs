...
public class Client
{
    ...
    public Task<BaseResponse> GetPage(string url, float timeoutSeconds = 5.0f, Dictionary<string, string>? cookies = null)
    {
        var request = new GetPageRequest(url, timeoutSeconds, cookies);
    ...
    /// <returns>>A BaseResponse containing either a PageResponse or an ErrorResponse</returns>
    public Task<BaseResponse> PressButtonOnPage(string buttonXPath, float timeoutSeconds = 5.0f)
    {
