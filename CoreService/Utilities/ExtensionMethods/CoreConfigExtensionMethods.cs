namespace CoreService.Utilities.ExtensionMethods;

public static class CoreConfigExtensionMethods
{
    public static void UpdateCredentials(this Core.Configuration.Credentials credentials, Credentials? newCredentials)
    {
